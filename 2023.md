...
Real-world applications lead to new computer vision challenges such as the need to adjust to varying light or weather conditions, cope with unseen scenes, dealing with uncertainty, adversarial attacks, etc. Supervised learning, which yet dominates the field, has limits there due to the stunning annotation time of 2D/3D data and the lack of diversity in the training datasets. Hence, the trend is to relax supervision (less labels, less data) which met considerable success lately building towards true self-supervised learning thanks to novel avenues of research on vision-language model, transfer learning, diffusion models, contrastive learning, vision transformers, continual learning, and many others. As a result the boundaries of computer vision have been dramatically pushed further which boost applications like autonomous driving, mobile robotics, virtual reality, image generation, etc.<br>
This full-day workshop will deep dive into recent research on computer vision with keynotes from renown scientists.
<br>
<br>
...
<b>🏆 The best work will be awarded with a prize (to be announced). 🏆</b><br>
<br>
...
## Important dates
- Submission deadline: <strong>August 4, 2023 (AOE).</strong>
- Decision notification: <strong>August 14, 2023.</strong>
